...
function App() {
  ...
  // <div>
  //   <div className="nav">
  //     <Navigation  cartLength={data.cartLength} isLogin={isLogin} displayLogin={login => setLogin(login)} displayRegister={register => setRegister(register)}/>
  //   </div>
  //   <div className="hero">
  //     <Hero />
  //   </div>
  ...
  //     <Dropdown status={user.statusUser} list={list}/>
  //   </div>
  //   <div style={{display: login}} className="absolute login">
  //     <Login isLogin={isLogin => setIsLogin(isLogin)}  display={login => setLogin(login)}/>
  //   </div>
  //   <div style={{display: register}} className="absolute register">
  //     <Register display={register => setRegister(register)}/>
  //   </div>
  ...
  //   cartLength: 0
  // })
  // let list = [{name: "Profile", img:"icon/user.svg"}]
  // if(user.statusUser === 1) {
  //   list = [{name: "Profile Patner", img:"icon/user.svg"}, {name: "Add Product", img:"icon/add-product.svg"}]
  // }
  // const al = () => {
  //   alert('hi')
  // }